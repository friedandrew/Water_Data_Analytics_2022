...
NeuseCond_monthly_ts <- ts(NeuseCond_monthly$Conductivity, frequency = 12)
NeuseCond_monthly_ts_decomposed <- stl(NeuseCond_monthly_ts, s.window = "periodic")
plot(NeuseCond_monthly_ts_decomposed)

NeuseCond_monthly_ts_decomposed_df <- as.data.frame(NeuseCond_monthly_ts_decomposed$time.series[,1:3])


```

The seasonality is small
